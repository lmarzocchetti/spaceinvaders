...
public class GameOverPanel extends JPanel implements MouseListener, MouseMotionListener, ActionListener {
	...
	/*
	 * Initialize the GameOverPanel, set the background color, add MouseListener and MouseMotionListener
	...
	/*
	 * Paint all components in the GameOverPanel:
	 * 	- Gameover string
